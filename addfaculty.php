...
<body>
 ...
 <br><div class="container"> 
  <div class="row" align="center">
    <div class="col-lg-6">
		<div class="jumbotron">
                Here you will Assign Professor
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="falname">Professor Name</label>  
				  <div class="col-md-5">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="Designation">Course Name</label>  
				  <div class="col-md-5">
