...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php"><!--BUPC --> UFV Appointment System</a>
    </div>
    <div>
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="addsubject.php"><span class="glyphicon glyphicon-plus-sign"></span> CRN Number</a></li>
        <li><a href="addfaculty.php"><span class="glyphicon glyphicon-plus-sign"></span> Professor</a></li> 
